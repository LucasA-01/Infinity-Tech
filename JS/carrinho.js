...
const produtos = {
  ...
  "pc-gamer": {
    ...
    descricao:
      "PC Gamer Ryzen 5 5600GT, 16GB DDR4, SSD 480GB e fonte 500W 80 Plus.",
    preco: 3788.51,
  ...
  "notebook-gamer": {
    ...
    descricao:
      "Intel Core Ultra 7 255HX, 16GB RAM, SSD 1TB, RTX 5060 e Windows 11.",
    preco: 13599.99,
  ...
  "pc-simples": {
    ...
    descricao:
      "Computador completo Intel Core i5, 16GB RAM, SSD 240GB, Monitor LED 19 e Windows 10.",
    preco: 1327.74,
  ...
  "notebook-simples": {
    ...
    descricao:
      "Notebook Positivo Vision C14, 4GB RAM, 128GB eMMC, Windows 11 Home.",
    preco: 1994.05,
  ...
  autocad: {
    ...
    descricao:
      "Software profissional para projetos de engenharia e arquitetura.",
    preco: 1299.0,
  ...
  revit: {
    nome: "Autodesk Revit",
    descricao:
      "Software BIM para projetos de arquitetura, engenharia e construção.",
    preco: 1499.0,
